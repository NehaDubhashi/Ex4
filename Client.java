...
public class Client {
    ...
    public static void myTest() {
        ...
        dict.insert(1, "");
        dict.insert(0, "");
        System.out.println(dict.root.height);
        System.out.println(dict.root.left.height);
        System.out.println(dict.root.right.height);
        System.out.println(dict.root.left.left.height);
        System.out.println(dict.root.left.right.height);
        dict.printSideways();
    }
